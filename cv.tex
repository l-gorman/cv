...
% CONTACT INFORMATION
%====================
\def\name{Léo Gorman} % Name Here
\def\phone{(+44) 07597672551}
\def\city{London, England}
\def\email{lgorman@turing.ac.uk}
\def\LinkedIn{léo-gorman-880014199} % linkedin.com/in/______
\def\github{l-gorman} % github username
\def\role{Doctoral Student} % JOB TITLE
